        ...
        <div className="rounded-2xl border border-warning/20 bg-gradient-to-r from-background/95 to-warning/5 shadow-xl backdrop-blur-xl">
          <div className="p-4 sm:p-6 md:p-8 lg:p-12">
            ...
            <div className="grid gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-5">
              ...
              <div className="sm:col-span-2 lg:col-span-2">
                <Link href="/" className="mb-6 flex items-center space-x-3">
                  ...
                  <div className="flex flex-col">
                    <span className="bg-gradient-to-r from-warning via-destructive to-accent bg-clip-text text-xl font-bold text-transparent sm:text-2xl">
                      GraphBit
                    </span>
                ...
                <p className="mb-4 max-w-sm text-sm leading-relaxed text-muted-foreground sm:mb-6 sm:text-base">
                  The complete platform for building, deploying, and monitoring AI agents. Trusted
              ...
              {/* Product links */}
              <div>
                <h3 className="mb-4 flex items-center gap-2 bg-gradient-to-r from-warning to-destructive bg-clip-text font-semibold text-transparent">
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <Link href="/tracing" className="text-muted-foreground">
                      LLM Tracing
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <Link href="/api" className="text-muted-foreground">
                      API Reference
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li>
                    <Link href="/help" className="text-muted-foreground">
                      Help Center
                    </Link>
                  </li>
                  <li>
